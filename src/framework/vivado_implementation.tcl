...
#
# Description     : A TCL scripts to connect accelerator module to the target IPs and build a FPGA project
# Dependencies    :
# Additional Comments:
#
# ///////////////////////////////////////////////////////////////////////////////////////
...
# ==============================================================
source ./implementation_settings.tcl
source -notrace ./implementation_extraction.tcl
set vivadoProjectName project
set vivadoProjectDir .
set hlsProjectName hls
set ip_repo_path {./ip}
set outputDir ./impl_report 
...
set cpd [get_property DIRECTORY [current_project]]
add_files -fileset constrs_1 $cpd/project.xdc
set_property target_constrs_file  $cpd/project.xdc   [current_fileset -constrset]

# setup design sources and constraints
set bd_design_name bd_0
set bd_inst_name hls_inst
set clock_freq_hz [expr {floor(1000 / $target_clk_period_ns) * 1000000}]
set ip_vlnv xilinx.com:hls:dnn_LeNet:1.0
...
report_power -file $outputDir/${top_module}_power_synth.rpt -name {power_2}
# launch run impl
