...
testcase=5
echo "Target : Test normal dse_pragma_clock on LeNet at 100 & 250MHz on Minimal Pragma!"
yes | cp -rf regression/input_arguments_$testcase.yaml input_arguments.yaml
python dnn_framework.py -mode dse_pragma_clock > regression/case_$testcase.log
